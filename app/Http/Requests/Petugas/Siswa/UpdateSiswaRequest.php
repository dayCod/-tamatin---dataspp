...
class UpdateSiswaRequest extends FormRequest
{
    ...
    {
        $siswa = Siswa::find(request()->segment(3));

        return [
            'nisn' => $this->request->get('nisn') == $siswa->nisn ? 'required|max:10' : 'required|max:10|unique:siswas,nisn',
            'nis' => $this->request->get('nis') == $siswa->nis ? 'required|max:8' : 'required|max:8|unique:siswas,nis',
            'nama' => 'required',
            'kelas_id' => 'required',
            'alamat' => 'required',
